...
export const pokemonMock = [
  ...
  },
  {
    ...
    summary:
      'The flame on its tail shows the strength of its life'
  ...
  },
  {
    ...
    summary:
      'For protection, it releases a horrible stench from the'
      + ' antennae on its head to drive away enemies.',
  },
  {
    id: 23,
    name: 'Ekans',
  ...
  },
  {
    ...
    summary:
      'What sounds like its cry may actually be its'
  ...
  },
  {
    ...
    summary:
      'They say that if it emits an aura from'
